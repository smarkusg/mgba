...
#if !defined(__3DS__) && !defined(GEKKO) && !defined(__AMIGAOS4__)
#define HAS_IPV6
#endif
...
//markus #ifdef GEKKO
//#if defined(GEKKO) && defined(AMIGAOS4)
//#ifdef AMIGAOS4 
#ifdef GEKKO
...
///markus fixme 	if (addr->ai_family == AF_INET && addr->ai_addrlen == sizeof(struct sockaddr_in)) {
...
//	}
		...
		result = WSANO_DATA;
#else
//markus fixme 		result = EAI_NONAME;
#endif
	}
error:
	if (addr) {
